...
export default function Reading() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors">
      ...
      <a 
        href="#main-content" 
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-black text-white dark:bg-white dark:text-black px-4 py-2 rounded z-50"
      >
      ...
      <nav className="w-full py-6 px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center">
            <Link href="/" className="text-lg font-normal tracking-tight hover:text-gray-600 dark:text-gray-200 dark:hover:text-gray-400 transition-colors">
              Abhi Raheja
            </Link>
            <div className="flex items-center space-x-8">
              <Link 
                href="/about" 
                className="text-gray-700 hover:text-black dark:text-gray-300 dark:hover:text-white transition-colors font-normal"
              >
                About
              </Link>
              <Link 
      ...
      <main id="main-content" className="px-6 md:px-12 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-16"
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight text-black dark:text-white mb-6 leading-tight">
              Reading
            </h1>
            <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 font-normal leading-relaxed max-w-3xl">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
              <div className="space-y-3">
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Michael Pollan</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Ayn Rand</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Matt Mochary</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Simon Sinek</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Lao Tzu</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Balaji Srinivasan</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Richard Schwartz</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Ram Dass</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Geoffrey Parker</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Carlos Castaneda</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Daniel Kahneman</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Paul Vigna</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Peter Thiel</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Ben Horowitz</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Yuval Noah Harari</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Michael Singer</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Rick Rubin</span>
                </p>
              </div>
              ...
              <div className="space-y-3">
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Peter Yang</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Ryan Holiday</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Walter Isaacson</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Antonio García Martínez</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Chris Dixon</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Shermin Voshmgir</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Malcolm Gladwell</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Mitch Albom</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Eckhart Tolle</span>
                </p>
                ...
                <p className="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">— Robert E. Svoboda</span>
                </p>
              </div>
            </div>
          </motion.div>
